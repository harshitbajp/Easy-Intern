...
$_SESSION['nxtu']=$currentuser;

?>
<?php


$querypro="select * from project";
			...
			<div class="profile-sidebar">
				...
				<div class="profile-usermenu">
					<ul class="nav">
						...
						<li>
							<a href="tasl1.php" target="_blank">
							<i  class="glyphicon glyphicon-ok" name="task"></i>
							Tasks </a>
						</li>
						<li>
							<a href="#">
		...
		<div class="col-md-9">
            <div class="profile-content">
			  <?php
                 if($numpro==0)
                 {
                 	echo'<h4>NO PROJECT AVAILABLE</h4>';
                 }
                 else{
                     echo '<h2 style="text-align:center;">AVAILABLE PROJECTS ARE</h2>';
              ...
              echo' <div class="card" style="width: 21rem; text-align:center;">';
               ...
               echo'<a href="" class="btn btn-danger">MORE DETAILS</a>';
               echo'<a href="studentprofile.php?id='.$projectid.'" class="btn btn-success" style="text-orientation: right">WORK ON THIS </a>';
...
if(isset($_GET['id']))
{
  ...
  $qo="insert into work_on (susername,pno) values('$currentuser',$project1)";
  mysqli_query($con,$qo);
    echo'<script>alert("GOOD LUCK WORK HARD!");</script>';
